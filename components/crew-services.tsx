    ...
    <div className="crew-app">
      ...
      <main className="main-content">
        ...
        <div className="page-body">
          ...
          <section className="kpi-grid"><Kpi label="Total crew" value="248" detail="↑ 6 this month" icon={UsersRound} tone="blue" /><Kpi label="Active today" value="186" detail="75% of total crew" icon={Activity} tone="green" /><Kpi label="Flights today" value="42" detail="4 require attention" icon={Plane} tone="amber" /><Kpi label="Open actions" value="12" detail="3 high priority" icon={AlertTriangle} tone="red" /></section>
