...
export default function CrewServices() {
  ...
  const action = (label: string) => setNotice(`${label} is available to Ellis James as Chairperson. Add a record here whenever you are ready.`)
